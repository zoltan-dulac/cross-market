...
// @version     0.2.0
// @description User-triggered form filling and copy tools for CrossMarket. Never submits a listing.
...
(() => {
  ...
  function buildUI() {
    ...
    panel.innerHTML = `
      ...
      <p class="mc-small">CrossMarket never presses the site's Post, Publish, Next, or Submit control.</p>
    ...
    if (typeof GM.registerMenuCommand === 'function') GM.registerMenuCommand('Open CrossMarket panel', openPanel);
  }
